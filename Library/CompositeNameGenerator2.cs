namespace NameProvider
{
        ...
        where TNameProvider : NameProvider, new()
    {
        ...
        private CompositeNameGenerator2() { Modifier = new EnumModifier(this); }
        ...
        {
            protected readonly CompositeNameGenerator2<TEnum, TNameProvider> Parent;

            public EnumModifier(CompositeNameGenerator2<TEnum, TNameProvider> parent) { Parent = parent; }
