...
namespace NameProvider
{
    ...
    public class FullNameGenerator
    {
        ...
        public FullNameGenerator() : this(new NameProviderFactory<MaleFemaleGendersAndSurname, RandomNameProvider>()) { }

        public FullNameGenerator(NameProviderFactory<MaleFemaleGendersAndSurname, RandomNameProvider> nameProviderFactory)
        {
        ...
        {
            return
                $@"{ProviderFactory.ProviderForNameType(Parse<MaleFemaleGendersAndSurname>(fullNameType)).Names.Take(1).Single()} {
                    ProviderFactory.ProviderForNameType(MaleFemaleGendersAndSurname.Surname).Names.Take(1).Single()}";
        }
        ...
        {
            return GetValues<FullNameType>().Select(AllNames).SelectMany(
                _ =>
                    {
